...
# Model and data
model_name="${1:-orbit-ai/orbit-4b-v0.1}"
dataset_name="${2:-all-8-wikipedia-test-datasets}"
...
run_name="${model_pretty_name}-${dataset_pretty_name}-eval-t${temperature}-search_r1-5turns-5docs"
...
export RETRIEVER_TIMEOUT=1200
export DEFAULT_TIMEOUT=1200
...
# Run evaluation (val_before_train=True with total_epochs=0 and total_training_steps=0)
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
    ...
    trainer.default_local_dir=${SCRIPT_DIR}/models/$run_name \
...
# Cleanup
echo "Evaluation completed. Cleaning up..."
